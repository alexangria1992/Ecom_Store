        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                ...
                <ul>
                    ...
                    <li><a href="checkoutt.php">My Account</a></li>
                </ul>
                <hr>
                <h4>User Section</h4>
                <ul>
            ...
            <div class="col-md-3 col-sm-6">
                <h4>Get the news</h4>
                <p class="text-muted">
                    Pellentesque habitant morbi tristique senectus et netus et malesuda fames ac turpis egstas.
                </p>
